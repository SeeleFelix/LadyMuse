...
export const artSubcategories = sqliteTable('art_subcategories', {
	id: integer('id').primaryKey({ autoIncrement: true }),
	categoryId: integer('category_id').notNull().references(() => artCategories.id),
	slug: text('slug').notNull().unique(),
	name: text('name').notNull(),
	nameZh: text('name_zh'),
	description: text('description'),
...
export const artTechniques = sqliteTable('art_techniques', {
	id: integer('id').primaryKey({ autoIncrement: true }),
	subcategoryId: integer('subcategory_id').notNull().references(() => artSubcategories.id),
	slug: text('slug').notNull().unique(),
	name: text('name').notNull(),
	nameZh: text('name_zh'),
	description: text('description'),
...
export const styles = sqliteTable('styles', {
	id: integer('id').primaryKey({ autoIncrement: true }),
	familyId: integer('family_id').notNull().references(() => styleFamilies.id),
	slug: text('slug').notNull().unique(),
	name: text('name').notNull(),
	nameZh: text('name_zh'),
	description: text('description'),
...
export const styleTechniqueRecs = sqliteTable('style_technique_recs', {
	...
	techniqueId: integer('technique_id').notNull().references(() => artTechniques.id),

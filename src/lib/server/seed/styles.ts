...
const families: FamilySeed[] = [
  {
    ...
    nameZh: "二次元/插画",
    description:
      "Japanese animation and illustration styles, from general anime aesthetics to specific studio looks.",
    sortOrder: 0,
  },
  {
    slug: "photorealistic",
    ...
    nameZh: "写实摄影",
    description:
      "Photography-based styles aiming for realistic imagery, covering cinematic, portrait, and editorial looks.",
    sortOrder: 1,
  },
  {
    slug: "oil-painting",
    ...
    nameZh: "油画",
    description:
      "Traditional oil painting styles spanning Renaissance classics to Impressionist masterworks.",
    sortOrder: 2,
  },
  {
    slug: "watercolor",
    ...
    nameZh: "水彩",
    description:
      "Soft, translucent watercolor techniques including illustration, botanical art, and landscape washes.",
    sortOrder: 3,
  },
  {
    slug: "digital-art",
    ...
    nameZh: "数字艺术",
    description:
      "Modern digital art styles including concept art, pixel art, and vector illustration.",
    sortOrder: 4,
  },
  {
    slug: "cyberpunk",
    ...
    nameZh: "赛博朋克/科幻",
    description:
      "Futuristic and dystopian aesthetics with neon lights, holograms, and high-tech imagery.",
    sortOrder: 5,
  },
  {
    slug: "fantasy",
    ...
    nameZh: "奇幻",
    description:
      "Magical and fantastical worlds, from epic high fantasy to dark gothic atmospheres.",
    sortOrder: 6,
  },
  {
    slug: "chinese-art",
    ...
    nameZh: "国风/水墨",
    description:
      "Traditional and modern Chinese art styles including ink wash painting, wuxia, and New Year prints.",
    sortOrder: 7,
  },
];
...
const styleSeeds: StyleSeed[] = [
  // ── Anime/Illustration ──────────────────────────────────────────────
  {
    ...
    nameZh: "通用二次元",
    description:
      "Versatile anime illustration style with cel shading and clean line work.",
    positiveTemplate:
  ...
  },
  {
    ...
    nameZh: "新海诚风格",
    description:
      "Vibrant, atmospheric anime style inspired by Makoto Shinkai films with stunning skies and lighting.",
    positiveTemplate:
    ...
    negativePrompt:
      "photorealistic, ugly, low quality, blurry, text, watermark",
    qualityTags:
      "masterpiece, best quality, highly detailed, stunning lighting",
  ...
  },
  {
    ...
    nameZh: "吉卜力风格",
    description:
      "Warm, hand-drawn aesthetic of Studio Ghibli with watercolor backgrounds and whimsical charm.",
    positiveTemplate:
  ...
  },
  {
    ...
    nameZh: "半写实二次元",
    description:
      "A blend of anime aesthetics with realistic rendering, semi-photorealistic skin and lighting.",
    positiveTemplate:
  ...
  // ── Photorealistic ──────────────────────────────────────────────────
  {
    ...
    nameZh: "电影感摄影",
    description:
      "Cinematic still photography with film grain, anamorphic lens effects, and dramatic composition.",
    positiveTemplate:
    ...
    qualityTags:
      "photorealistic, ultra detailed, 8k uhd, RAW photo, high resolution",
    recommendedParams: '{"steps": 30, "cfg": 7, "sampler": "DPM++ 2M Karras"}',
  ...
  },
  {
    ...
    nameZh: "人像摄影",
    description:
      "Professional portrait photography with bokeh, studio lighting, and shallow depth of field.",
    positiveTemplate:
    ...
    negativePrompt:
      "cartoon, anime, painting, illustration, drawing, deformed, ugly, low quality",
    qualityTags:
      "photorealistic, ultra detailed, 8k uhd, RAW photo, sharp focus",
    recommendedParams: '{"steps": 30, "cfg": 7, "sampler": "DPM++ 2M Karras"}',
  ...
  },
  {
    ...
    nameZh: "时尚摄影",
    description:
      "High-end fashion editorial style with dramatic lighting and striking composition.",
    positiveTemplate:
    ...
    negativePrompt:
      "casual, amateur, low quality, blurry, painting, anime, cartoon",
    qualityTags:
      "photorealistic, ultra detailed, 8k uhd, RAW photo, magazine quality",
    recommendedParams:
      '{"steps": 30, "cfg": 7.5, "sampler": "DPM++ 2M Karras"}',
  ...
  // ── Oil Painting ────────────────────────────────────────────────────
  {
    ...
    nameZh: "文艺复兴油画",
    description:
      "Classical Renaissance oil painting with rich colors, detailed brushwork, and timeless composition.",
    positiveTemplate:
    ...
    negativePrompt:
      "photo, photograph, modern, anime, cartoon, digital art, blurry",
    qualityTags:
      "masterpiece, best quality, highly detailed, classical art, museum quality",
    recommendedParams: '{"steps": 30, "cfg": 7, "sampler": "DPM++ 2M Karras"}',
  ...
  },
  {
    ...
    nameZh: "印象派",
    description:
      "Impressionist painting with visible brushstrokes, emphasis on light and color, inspired by Monet and Renoir.",
    positiveTemplate:
    ...
    negativePrompt:
      "photo, realistic, modern, digital art, anime, sharp lines, smooth",
    qualityTags:
      "masterpiece, best quality, artistic, beautiful colors, painterly",
    recommendedParams: '{"steps": 28, "cfg": 7, "sampler": "Euler a"}',
  ...
  // ── Watercolor ──────────────────────────────────────────────────────
  {
    ...
    nameZh: "水彩插画",
    description:
      "Soft, flowing watercolor illustration with wet-on-wet technique and delicate paper texture.",
    positiveTemplate:
    ...
    negativePrompt:
      "photo, realistic, digital, oil painting, acrylic, sharp lines",
  ...
  },
  {
    ...
    nameZh: "植物水彩",
    description:
      "Detailed botanical watercolor illustration with scientific accuracy and delicate color layering.",
    positiveTemplate:
    ...
    qualityTags:
      "masterpiece, best quality, highly detailed, scientific accuracy",
    recommendedParams: '{"steps": 28, "cfg": 7, "sampler": "DPM++ 2M Karras"}',
  ...
  // ── Digital Art ─────────────────────────────────────────────────────
  {
    ...
    nameZh: "概念艺术",
    description:
      "Professional concept art style commonly seen in game and film production, detailed and atmospheric.",
    positiveTemplate:
    ...
    qualityTags:
      "masterpiece, best quality, highly detailed, professional, artstation",
    recommendedParams: '{"steps": 30, "cfg": 7, "sampler": "DPM++ 2M Karras"}',
  ...
  },
  {
    ...
    nameZh: "像素艺术",
    description:
      "Retro pixel art style with limited color palette and nostalgic 8-bit/16-bit aesthetics.",
    positiveTemplate:
    ...
    negativePrompt:
      "photo, realistic, blurry, smooth, 3d render, high resolution texture",
  ...
  // ── Cyberpunk/Sci-Fi ────────────────────────────────────────────────
  {
    ...
    nameZh: "赛博朋克霓虹",
    description:
      "Classic cyberpunk with neon-lit streets, rain-slicked cityscapes, and high-tech low-life atmosphere.",
    positiveTemplate:
    ...
    negativePrompt:
      "medieval, fantasy, nature, bright, sunny, clean, traditional",
    qualityTags:
      "masterpiece, best quality, highly detailed, cinematic lighting, neon glow",
    recommendedParams:
      '{"steps": 30, "cfg": 7.5, "sampler": "DPM++ SDE Karras"}',
  ...
  },
  {
    ...
    nameZh: "太空科幻",
    description:
      "Epic space opera aesthetic with vast starfields, spacecraft, and futuristic technology.",
    positiveTemplate:
    ...
    negativePrompt:
      "medieval, fantasy, nature, primitive, low tech, cartoon, anime",
    qualityTags:
      "masterpiece, best quality, highly detailed, epic, cinematic, 8k",
    recommendedParams: '{"steps": 30, "cfg": 7, "sampler": "DPM++ 2M Karras"}',
  ...
  // ── Fantasy ─────────────────────────────────────────────────────────
  {
    ...
    nameZh: "史诗奇幻",
    description:
      "Grand high fantasy style with sweeping landscapes, heroic characters, and magical grandeur.",
    positiveTemplate:
    ...
    negativePrompt:
      "modern, sci-fi, cyberpunk, realistic photo, mundane, boring",
    qualityTags:
      "masterpiece, best quality, highly detailed, epic, grand, magical",
    recommendedParams: '{"steps": 30, "cfg": 7, "sampler": "DPM++ 2M Karras"}',
  ...
  },
  {
    ...
    nameZh: "暗黑哥特",
    description:
      "Dark, moody gothic atmosphere with shadows, ancient architecture, and an ominous feel.",
    positiveTemplate:
    ...
    qualityTags:
      "masterpiece, best quality, highly detailed, atmospheric, dark, moody",
    recommendedParams:
      '{"steps": 30, "cfg": 7.5, "sampler": "DPM++ SDE Karras"}',
  ...
  // ── Chinese Art ─────────────────────────────────────────────────────
  {
    ...
    nameZh: "水墨画",
    description:
      "Traditional Chinese ink wash painting with minimalist composition, xuan paper texture, and sumi-e brushwork.",
    positiveTemplate:
    ...
    negativePrompt:
      "photo, realistic, colorful, modern, digital, oil painting, western",
  ...
  },
  {
    ...
    nameZh: "武侠风格",
    description:
      "Wuxia martial arts aesthetic with flowing robes, ink painting influences, and ethereal atmosphere.",
    positiveTemplate:
    ...
    negativePrompt:
      "photo, realistic, modern, western, sci-fi, cyberpunk, cartoon",
    qualityTags:
      "masterpiece, best quality, highly detailed, ethereal, elegant",
    recommendedParams: '{"steps": 28, "cfg": 7, "sampler": "DPM++ 2M Karras"}',
  ...
  },
  {
    ...
    nameZh: "年画",
    description:
      "Traditional Chinese New Year woodblock print style with bold colors, auspicious symbols, and festive motifs.",
    positiveTemplate:
    ...
    negativePrompt:
      "photo, realistic, modern, western, dark, moody, anime, digital art",
    qualityTags:
      "masterpiece, best quality, vibrant colors, traditional, festive",
...
export async function seedStyles(db: DB): Promise<void> {
  ...
  for (const style of styleSeeds) {
    ...
    if (!familyId) {
      console.warn(
        `Skipping style "${style.slug}": family "${style.familySlug}" not found`,
      );
      continue;
    }
  ...
  console.log(
    `Seeded ${families.length} style families and ${styleSeeds.length} styles.`,
  );
}
